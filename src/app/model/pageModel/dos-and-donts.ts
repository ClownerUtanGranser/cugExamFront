...
export class DosAndDontsObj {
  ...
  dosAndDontsWhenWorkingWithChildrenArb:dosAndDonts = {
    ...
    whistleBlowerPolicyArb:dosAndDonts = {
      ...
      dosText:[
        'إذا كنت على علم بأن شخصًا ما في المنظمة يرتكب مخالفات، يجب أن تتصل على الفور بأقرب نقطة اتصال لك بالمنظمة. إذا كنت لا ترغب في التواصل مع أقرب نقطة اتصال لك، فيمكنك دائمًا الاتصال بالأمين العام أو أحد أعضاء مجلس الإدارة.',
        '',
